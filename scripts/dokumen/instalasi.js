...
const isi = [
  ...
  p([tebal("siapkan-env.mjs"), biasa(" membuat berkas .env beserta seluruh kunci rahasianya, lalu menampilkan kata sandi untuk masuk pertama kali. Catat kata sandi itu.")]),
  ...
  tabel(
    ...
    [
      ...
      ["□", "Berkas .env ada, dan kata sandi masuk pertama sudah dicatat"],
